      ...
      <div id="navbarCollapse" class="hidden uppercase font-bold text-blue-dark justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="navbar-cta">
        <ul class="flex flex-col mt-4 lg:flex-row lg:mt-0 lg:text-sm lg:font-medium">
          <li class="nav-link active">
            <a href="./index.html" class="block py-2 px-3 hover:text-blue-light dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Home</a>
          </li>
          <li class="nav-link">
            <a href="./about-us.html" class="block py-2 px-3 hover:text-blue-light dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">About Us</a>
          </li>
          <li class="nav-link">
            <a href="./manufacturing-unit.html" class="block py-2 px-3 hover:text-blue-light dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Manufacturing unit</a>
          </li>
          <li class="nav-link">
            <a href="./products.html" class="block py-2 px-3 hover:text-blue-light dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Products</a>
          </li>
          <li class="nav-link">
              <a href="./quality.html" class="block py-2 px-3 hover:text-blue-light dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Quality</a>
          </li>
          <li class="nav-link">
              <a href="./contact-us.html" class="block py-2 px-3 hover:text-blue-light dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Contact Us</a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="flex flex-col lg:flex-row justify-between border-b border-blue-light pb-8">
   ...
   <div class="mt-6 md:mt-0 lg:pl-10 text-lg text-gray-300 leading-loose">
    ...
    <a href="./quote-request.html" class="inline-flex w-max items-center uppercase mt-10 py-3 px-5 text-sm font-medium text-center text-white bg-blue-light rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Quote a request
    </a>
   </div>
  </div>
